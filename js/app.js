const ingresos = [
    ...
    new Ingreso('Venta coche', 1000.00)
];
...
const formatoPorcentaje = (valor) => {
    return valor.toLocaleString('es-ES', {style: 'percent', maximumFractionDigits: 2});
}
...
let agregarDato = () => {
    ...
    if (descripcion.value !== '' && valor.value !== '') {
        ...
        alert("Por favor ingrese una descripción y un valor válido."); 
    }
}